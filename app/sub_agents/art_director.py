...
class ArtDirector:
    def __init__(self):
        ...
        # )
      try:
        with open("app/prompts/art_director.md", "r") as f:
    ...
    def _generate_style_guide_prompt(self, trend_data: Trend, product_description: str = "") -> str:
        ...
        try:
            with open("app/prompts/graphic_designer.md", "r") as f:
    ...
    def load_trend_data(self, tool_context: ToolContext) -> List[Trend]:
    ...
    def create_moodboards(self, tool_context: ToolContext, trend_data: List[Trend], product_image_path: str = "") -> List[str]:
        """
