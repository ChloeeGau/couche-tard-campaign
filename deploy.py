...
def _get_env_vars() -> dict[str, str]:
    if not _env_vars:
        ...
        env_var_keys = [
            ...
            "IMAGE_GENERATION_TENACITY_ATTEMPTS",
            "IMAGE_GENERATION_EVAL_REATTEMPTS",
            "IMAGE_GENERATION_CONCURRENCY_LIMIT",
            "IMAGE_GENERATION_RETRY_DELAY_SECONDS",
            "IMAGE_DEFAULT_ASPECT_RATIO",
            "VIDEO_GENERATION_STATUS_POLL_SECONDS",
            "VIDEO_GENERATION_MODEL",
            "VIDEO_DEFAULT_ASPECT_RATIO",
            "VIDEO_FPS",
            "LLM_GEMINI_MODEL_ADGEN_SUBCALLS",
            "VIDEO_GENERATION_EVAL_REATTEMPTS",
            "VIDEO_GENERATION_RETRY_DELAY_SECONDS",
            "VIDEO_GENERATION_STATUS_POLL_SECONDS",
            "VIDEO_GENERATION_TENACITY_ATTEMPTS",
            "VIDEO_GENERATION_CONCURRENCY_LIMIT",
