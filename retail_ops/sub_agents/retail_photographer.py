...
class RetailPhotographer:
    ...
    def generate_campaign_image(self, product_image_path: str, art_direction: str) -> str:
        """
        Generates a marketing campaign image for a product based on a consumption gap.
...
# NANO BANANA
            ...
            for gcs_image in gcs_images:
              ...
              if gcs_image.startswith("gs://") or gcs_image.startswith("https://"):
                  bucket_name = (
...
# IMAGEN
            ...
            logging.error(f"Retail Photography Failed: {e}")
            return None
