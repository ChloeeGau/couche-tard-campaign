...
try:
    from app.sub_agents.strategist import Strategist
    from app.schema import Trend, TrendStrategy, TaxonomyAttributes, MarketingAttributes, TargetAudienceProfile
